extensions [qlearningextension qlearningextension qlearningextension qlearningextension array]
...
to test
  ...
  while[i < testround][
    ...
    print i + 1
    print ticks
    if ticks > best [set best ticks]
    set pj ((i * pj) + ticks) / (i + 1)
    print pj
    setup
    set i i + 1
  ]
